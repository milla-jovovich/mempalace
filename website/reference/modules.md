...
JSON-RPC over stdin/stdout. Implements the MCP protocol with 30 tools covering palace read/write, drawer CRUD, knowledge graph, navigation, tunnels, agent diary, wake-up context, and system operations. Includes the Memory Protocol, Layer 0/1 wake-up context, and AAAK Spec in status responses.
