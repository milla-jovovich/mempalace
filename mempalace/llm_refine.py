...
def _build_corpus_origin_preamble(corpus_origin: dict | None) -> str:
    """Build a system-prompt preamble carrying Phase 1 corpus-origin context.
    ...
    lines = ["\n\nCORPUS CONTEXT (Phase 1 corpus_origin):"]
    ...
    if personas:
        ...
        lines.append(
            ...
            "Classify them as PERSON (a downstream Phase 1 step tags them "
            "as agent personas)."
        )
    return "\n".join(lines)
