...
#
# This hook optionally auto-ingests MEMPAL_DIR, then returns {}. Claude Code
# recognizes "block" or {}, not "allow".
...
PYTHON="${MEMPALACE_PYTHON:-$(command -v python3 2>/dev/null || command -v python 2>/dev/null || echo python3)}"
...
# Empty JSON means allow/proceed. "decision": "allow" is invalid.
echo '{}'
